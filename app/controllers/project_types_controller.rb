  ...
  def create
    ...
    respond_to do |format|
      if @project_type.save
        format.html { redirect_to(@project_type, :notice => 'ProjectType was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @project_type.update_attributes(params[:project_type])
        format.html { redirect_to(@project_type, :notice => 'ProjectType was successfully updated.') }
        format.xml  { head :ok }
      else
